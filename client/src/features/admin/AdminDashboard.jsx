  ...
  return (
    <div className="animate-fade-up">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-2xl border-2 border-gray-200 shadow-[4px_4px_0px_0px_#D1D5DB]">
          <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-4">
            <Users className="w-6 h-6 text-blue-600" />
          </div>
          <p className="text-gray-500 font-bold text-sm">Total Users</p>
          <h2 className="text-4xl font-black text-gray-900 mt-1">{stats?.totalUsers || 0}</h2>
        </div>

        <div className="bg-white p-6 rounded-2xl border-2 border-amber-200 shadow-[4px_4px_0px_0px_#FDE68A]">
          <div className="w-12 h-12 bg-amber-100 rounded-xl flex items-center justify-center mb-4">
            <Clock className="w-6 h-6 text-amber-600" />
          </div>
          <p className="text-amber-800 font-bold text-sm">Pending Verifications</p>
          <h2 className="text-4xl font-black text-amber-900 mt-1">{stats?.pendingVerifications || 0}</h2>
        </div>

        <div className="bg-white p-6 rounded-2xl border-2 border-green-200 shadow-[4px_4px_0px_0px_#A7F3D0]">
          <div className="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center mb-4">
            <UserCheck className="w-6 h-6 text-green-600" />
          </div>
          <p className="text-green-800 font-bold text-sm">Verified Users</p>
